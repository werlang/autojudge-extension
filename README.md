...
1. Open this folder as a separate VS Code workspace.
2. Run the `AutoJudge: Run Active File` command from the Command Palette, or click the editor title button.
3. Inspect results in the `AutoJudge` output channel.
